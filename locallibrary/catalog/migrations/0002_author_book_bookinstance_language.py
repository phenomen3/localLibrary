# Generated by Django 3.2.12 on 2023-06-26 23:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Ingresa el lenguaje natural del libreo (Ingles, Frances, Japones, etc.)', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
